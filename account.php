...
<div class="row">
<div class="col-lg-6">
<span class="logo">Apti Prep</span></div>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li <?php if(@$_GET['q']==4) echo'class="active"'; ?>><a href="learn.php"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;Learn</a></li>
    <li <?php if(@$_GET['q']==5) echo'class="active"'; ?>><a href="account.php?q=4"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;Process</a></li>
...
<!--learn start-->
<?php
// Check if a specific action is triggered (e.g., a button click)
if(@$_GET['q']==4) {
  if (isset($_POST['learn_button'])) {
